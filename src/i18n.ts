...
const LANGUAGES: Record<string, Record<string, string>> = {
  en: {
    ...
    calculateMarkup: 'Calculate Markup',
    checked: 'Checked',
    cleanAll: 'Clean All',
  ...
  lt: {
    ...
    calculateMarkup: 'Skaičiuoti antkainį',
    ...
    newDraft: 'Naujas juodraštis',
    newItem: 'Nauja prekė',
    newPriceIs: 'Nauja kaina: ',
    newWriteOff: 'Naujas nurašymas',
    ...
    writeOff: 'Nurašymas',
    writeOffItems: 'Prekių nurašymas',
    yes: 'Taip',
    zero: 'nulis',
  }
}
